...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ourearth-project/ourearth>";
    const std::string URL_WEBSITE = "<https://oec.life>";
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2011, COPYRIGHT_YEAR) + " ") + "\n" +
           ...
           strprintf(_("Distributed under the MIT software license, see the accompanying file")) + "\n" +
           "\n" +
