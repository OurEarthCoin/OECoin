...
const char * const BITCOIN_CONF_FILENAME = "ourearth.conf";
const char * const BITCOIN_PID_FILENAME = "ourearth.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ourearth";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ourearth";
#else
    // Unix
    return pathRet / ".ourearth";
#endif
#endif
}
