...
#if defined(NDEBUG)
# error "Ourearth cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Ourearth Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s OE additional fees, %d delta bytes\n",
