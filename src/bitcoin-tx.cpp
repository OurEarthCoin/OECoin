...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ourearth-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ourearth-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ourearth transaction") + "\n" +
              "  ourearth-tx [options] -create [commands]   " + _("Create hex-encoded ourearth transaction") + "\n" +
              "\n";
